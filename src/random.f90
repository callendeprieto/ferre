...
PRIVATE            :: integral
!! dpr is private and local, so it will remain double precision 
!! independently from the dp parameter in share.f90 or elsewhere
INTEGER, PARAMETER,PRIVATE :: dpr = SELECTED_REAL_KIND(12, 60)
